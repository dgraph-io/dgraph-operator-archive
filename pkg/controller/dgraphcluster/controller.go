...
func NewController(k8sClient kubernetes.Interface,
	...
	recorder := eventBroadcaster.NewRecorder(scheme.Scheme, v1.EventSource{Component: defaults.DgraphOperatorName})

	workqueue := workqueue.NewNamedRateLimitingQueue(workqueue.DefaultControllerRateLimiter(), "DgraphClusters")
